...
def generate_feedback(raw_text: str, context: str) -> dict:
    prompt = (
        ...
        "이 피드백은 초등학생들을 위한 피드백임으로 초등학생들이 이해하기 쉽게 기초적인 내용으로 작성해주세요\n"
...
example_title=[
    "✅ 1. 시간의 흐름에 따라 요약",
    "✅ 2. 장소의 이동에 따라 요약",
    "✅ 3. 이야기 구조에 따라 요약 (발단–전개–위기–절정–결말)",
    "✅ 4. 육하원칙에 따라 요약 (누가, 언제, 어디서, 무엇을, 어떻게, 왜)",
    "✅ 5. 등장인물 중심 요약"
]

examples=[
    "옛날에 흥부와 놀부 형제가 살았어요. 형 놀부는 욕심이 많아 흥부를 내쫓았고, 흥부는 가난하지만 착하게 살았어요. 어느 날 흥부는 다친 제비를 정성껏 치료해 주었고, 제비는 박씨 한 알을 물어다 주었어요. 흥부는 그 박을 가꾸어 보았는데, 박 속에서 금은보화가 나와 큰 부자가 되었어요. 그걸 본 놀부도 제비 다리를 일부러 부러뜨려 박씨를 얻었지만, 그 박 속에서는 괴물과 벌이 나와 큰 혼쭐이 났어요.",
    "흥부는 가난한 집에서 아내와 아이들과 함께 힘들게 살았어요. 어느 날 집 앞에서 다친 제비를 발견하고 정성껏 치료해주었죠. 그 후 제비가 물어다 준 박씨를 심어 박을 따 보니, 금은보화가 가득 들어 있었어요. 놀부는 이 소식을 듣고 흥부네 집을 찾아가 박씨를 얻게 된 이야기를 듣고 따라 해요. 자기 집에서 박을 키워 자르자 괴물이 튀어나와 온 집이 엉망이 되었고, 결국 놀부는 자신의 잘못을 깨닫게 되었어요.",
    ...
    "흥부는 가난했지만 마음이 착해 다친 제비를 정성껏 돌봐 주었어요. 제비가 가져온 박씨를 심었더니, 박 속에서 금은보화가 나와 큰 부자가 되었어요. 놀부는 그 이야기를 듣고 흥부를 따라 했지만, 욕심을 부려 제비를 일부러 다치게 했어요. 결국 놀부가 키운 박에서는 괴물과 벌이 나왔고, 놀부는 크게 혼이 났어요. 그 일로 놀부는 자신의 잘못을 깨닫고 흥부와 화해하게 되었어요."
    ]
...
if st.session_state.stage == "init":
    st.title("🖋️ AI와 상호 작용하여 이어지는 이야기 생성해보자!")
